...
print(crayons.cyan(f'\nBrainStorm made by BrainStormFN '
                   'Credit to Terbau for creating the library.'))
print(crayons.cyan(f'The official code for 1.BrainStorm'))
...
class AuraBot(commands.Bot):
    def __init__(self, email : str, password : str, **kwargs) -> None:
        ...
        self.server = server
        self.welcome_message = "Hello, {DISPLAY_NAME} join: https://dsc.gg/brainstormfn for a free lobbybot!"
        self.whisper_message = "If you need help or want your own bot join here:https://dsc.gg/brainstormfn"
    ...
    async def gift(self, ctx: fortnitepy.ext.commands.Context) -> None:
        ...
        await ctx.send('You thought i would gift you lol. XD')
    ...
    async def clean(self, ctx: fortnitepy.ext.commands.Context) -> None:
        ...
        print(crayons.cyan(f'BrainStormFV-v1 made by BrainStormFN '
                           'Massive credit to Terbau for creating the library'))
        print(crayons.cyan(
            f'Discord server: https://dsc.gg/brainstormfn - For support, questions, etc.'))
